...
- 今回が**第1回目**の対面 Bioconductor Carpentries 日本語ワークショップです。
  ...
  - **第2回目**も[9月11日-12日に京都府立大学でJSBiの公募研究会として開催されることが決まりました](https://www.jsbi.org/activity/koubo/detail--id-935.html)
...
- 5日：[RとBioconductorによるデータ分析](https://bioconductor-translations.github.io/bioc-intro-ja/)

- 6日：[Bioconductorプロジェクト](https://bioconductor-translations.github.io/bioc-project-ja/)

上記のリンクからレッスンの内容にアクセスできます<br>（PLaMo翻訳による翻訳が含まれています）
